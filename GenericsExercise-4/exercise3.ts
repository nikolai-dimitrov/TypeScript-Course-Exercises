...
// mechanic.technicalInspection(maybeCar4); //TS Error mechanic.technicalInspection(notACar); //TS Error
// mechanic.technicalInspection(maybeCar); //TS Error mechanic.technicalInspection(maybeCar3); //TS Error
